...
import { menulinks } from "@/menu-data/menu-links";
...
export default function Sidebar2({ className, isCollapsed, setIsCollapsed }) {
    ...
    return (
        ...
        >
            ...
            <Layout>
                {/* Header */}
                <LayoutHeader className="sticky top-0 justify-between px-4 py-1.5 border-b md:px-4">
                    <div
                    ...
                    >
                        ...
                        >
                            <span className="font-medium">Glopsy Admin</span>
                            <span className="text-xs">Directory Listings</span>
                        </div>
                    </div>
